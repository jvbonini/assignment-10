...
def init_browser():
    ...
    executable_path = {"executable_path": "/Users/joaob/Desktop/chromedriver"}
    return Browser("chrome", **executable_path, headless=False)


# Create Mission to Mars dictionary that can be imported into MongoDB
mars_info = {}
...
def scrape_mars_news():
    try: 
        ...
        # Go to Nasa news url through splinter module
...
def scrape_mars_image():
    ...
    try:
        ...
        featured_image_url 
        # Dictionary entry from Mars Space Images
...
def scrape_mars_hemispheres():
    ...
    try: 
        ...
        for i in items: 
            ...
            # Create a Beautiful Soup for every individual hemisphere information website 
